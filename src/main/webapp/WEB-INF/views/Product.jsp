        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="filters-content">
                <div class="row grid">
                  <table cellpadding="20" cellspacing="20" style="border:0px solid transparent; margin-left: auto; margin-right: auto;">
                    <c:forEach var="product" items="${cars}">
                    <tr>
                      <td>
                        <div class="product-item">
                          <a href="#"><img src="../../images/Products.jpg" style="height: 200px; width: 350px;" alt=""></a>
                          <div class="down-content">
                            <h6 >${product.pid}</h6><br>
                            <a href="#"><h4>${product.name}</h4></a><br>
