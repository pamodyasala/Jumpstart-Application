        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <a href="#"><h4>Leather Boots</h4></a>
                <h6>$ 25</h6>
                <p>High quality leather boots. Timberland brand. Heavey duty.</p>
                <ul class="stars">
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <a href="#"><h4>Ice cap Unisex</h4></a>
                <h6>$ 15</h6>
                <p>Best Ice caps for winter season. Quality qool wiven. Excellent.</p>
                <ul class="stars">
                  <li><i class="fa fa-star"></i></li>
                  <li><i class="fa fa-star"></i></li>
                  <li><i class="fa fa-star"></i></li>
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <a href="#"><h4>Blankets</h4></a>
                <h6>$ 20</h6>
                <p>Best Blankets for winter season. Quality qool wiven. Excellent.</p>
                <ul class="stars">
                  <li><i class="fa fa-star"></i></li>
                  <li><i class="fa fa-star"></i></li>
                  <li><i class="fa fa-star"></i></li>
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <a href="#"><h4>High quality JBL Bins</h4></a>
                <h6>$ 100</h6>
    ...
    <div class="best-features">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>About Jumpstart</h2>
            </div>
          </div>
          <div class="col-md-6">
            <div class="left-content">
              <h4>Looking for the best products?</h4>
              <p><a rel="nofollow" href="https://templatemo.com/tm-546-sixteen-clothing" target="_parent">Jumpstart</a> retail chain owns 750 stores nationwide. They reach out to the customers because of the
                 quality and creativity of their products. A new norm of remote working has emerged in the post-Covid 19 disturbed their core business in different respects</p>
