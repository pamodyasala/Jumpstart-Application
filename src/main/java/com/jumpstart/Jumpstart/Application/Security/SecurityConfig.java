package com.jumpstart.Jumpstart.Application.Security;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET, "/products").hasAnyRole("Users","Administrator")
                    .antMatchers(HttpMethod.GET,"/new_car").hasRole("Administrator")
                    .antMatchers(HttpMethod.POST, "/cars").hasAnyRole("Users","Administrator")
                    .antMatchers(HttpMethod.GET,"/vieworder").hasRole("Administrator")
